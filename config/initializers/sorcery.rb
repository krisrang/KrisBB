...
# Available submodules are: :user_activation, :reset_password, :session_timeout, :external
Rails.application.config.sorcery.submodules = [:http_basic_auth, :remember_me, :brute_force_protection, :activity_logging]
...
Rails.application.config.sorcery.configure do |config|
  ...
  # Default: `nil`
  #
  config.cookie_domain = 'forum.kristjanrang.eu'
