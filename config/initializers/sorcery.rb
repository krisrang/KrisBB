...
Rails.application.config.sorcery.submodules = [:remember_me, :brute_force_protection, :http_basic_auth, :activity_logging]
...
Rails.application.config.sorcery.configure do |config|
  ...
  config.user_config do |user|
    ...
    user.login_lock_time_period = 60 * 30                                             # how long the user should be
